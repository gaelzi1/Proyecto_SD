...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///transactions_uli.db'  # Base de datos específica para ULI
...
def create_transaction_uli():
    data = request.json
    try:
        phone_number = data['phone_number']
        amount = data['amount']
        commission_rate = 0.05  # Comisión para ULI (5%)
